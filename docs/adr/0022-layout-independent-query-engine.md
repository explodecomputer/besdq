...
The public BESDQ query API is layout-independent from the start. Callers query a Store Release for variants, ranges, analyses, full analyses, or top hits without knowing whether associations are stored in Dense, Ragged, or Dense-plus-Overflow form.
